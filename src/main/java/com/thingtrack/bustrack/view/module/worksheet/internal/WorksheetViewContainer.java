...
public class WorksheetViewContainer extends AbstractViewContainer {
	@AutoGenerated
	...
	private static ThreadLocal<WorksheetService> threadWorkSheetService = new ThreadLocal<WorksheetService>();
	...
	* visual editor.
	*/
	public WorksheetViewContainer (IWorkbenchContext context) {
	...
	private void createViews() {
		...
		threadWorkSheetService.set(worksheetService);
		
		// add all views controlled by SliderView Component
		worksheetView = new WorksheetView(this);
		sliderView.addView(worksheetView);
		views.put(0, worksheetView);
	...
	private void destroyViews() {
		...
		threadWorkSheetService.set(null);
	}
   ...
   public static WorksheetService getWorksheetService(){
	   return threadWorkSheetService.get();
   }
